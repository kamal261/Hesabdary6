// SmsFinance file version: 4 — grafted two proven fixes from the Hesabdary6/v1 branch onto this
// file's simple single-file skeleton (kept everything else as-is on purpose):
