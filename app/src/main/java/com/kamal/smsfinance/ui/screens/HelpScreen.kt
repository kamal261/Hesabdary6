...
private val HELP_SECTIONS = listOf(
    HelpSection(
        ...
        "وقتی برنامه رو باز می‌کنید، پیامک‌های جدید بانکی از صندوق پیامک بررسی و به تراکنش تبدیل می‌شن. " +
            "همه‌چیز روی خودِ گوشی پردازش می‌شه؛ هیچ پیامکی به سرور فرستاده نمی‌شه. اگر اجازه پیامک رو " +
            "نداده باشید، ثبت دستی و گزارش‌ها همچنان کار می‌کنن."
    ),
    HelpSection(
        "تراکنش‌ها",
        "لیست کامل تراکنش‌های شناسایی‌شده. با زدن روی هرکدوم می‌تونید نوع هزینه/درآمد، زیرشاخه و طرف‌حساب " +
            "رو مشخص کنید. بعد از انتخاب دسته، گزینه افزودن یادداشت در انتهای همین بخش قرار داره. " +
