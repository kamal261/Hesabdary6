        ...
        fun getInstance(context: Context): AppDatabase =
            INSTANCE ?: synchronized(this) {
                INSTANCE ?: Room.databaseBuilder(
                    ...
                    // Do not use fallbackToDestructiveMigration(): silently deleting a user's
                    // financial database is worse than failing loudly. Before supporting any
                    // older schema, add and test a real Migration for that version.
